...
import shop1 from "../assets/images/shop5.webp";
...
const ProductDetail5 = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const cartItem = {
      productName: " Coco Winter Unstitched Collection - 5A",
      price: 9916,
      quantity,
      user: formData,
    };
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10">
          ...
          <div className="flex-1">
            <h2 className="text-2xl font-medium mb-2">
              Coco Winter Unstitched Collection - 5A
            </h2>
            <p className="text-gray-500 mb-3 line-through">Rs9,490.00</p>
            <p className="text-2xl font-bold text-black mb-4">Rs8,990.00</p>
